...
namespace PaazlCheckoutWidget\Core\Checkout\Cart\SalesChannel;
...
class CartOrderRouteUpdate extends CartOrderRoute
{
    ...
    public function order(Cart $cart, SalesChannelContext $context, RequestDataBag $data): CartOrderRouteResponse
    {
        ...
        $criteria
            ...
            ->addAssociation('orderCustomer.customer.addresses')
            ->addAssociation('orderCustomer.customer.addresses.country')
